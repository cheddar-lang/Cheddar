...
describe('IO', function() {
    ...
    describe('sprintf', function() {
        it('string should work', TestCheddarFrom.Code(
            `print Console.sprintf("Hello, World!")`,
            `Hello, World!`
        ))

        describe('specifiers', function() {
            it('%d', TestCheddarFrom.Code(
                `print Console.sprintf("1 + 1 = %d", 2)`,
                `1 + 1 = 2`
            ))

            it('%i', TestCheddarFrom.Code(
                `print Console.sprintf("1 + 1 = %i", 2)`,
                `1 + 1 = 2`
            ))

            it('%x', TestCheddarFrom.Code(
                `print Console.sprintf("1 + 1 = %x", 255)`,
                `1 + 1 = ff`
            ))
            ...
            it('%r', TestCheddarFrom.Code(
                `print Console.sprintf("[1,2,3]=%r", [1,2,3])`,
                `[1,2,3]=[1, 2, 3]`
            ))

            it('%s', TestCheddarFrom.Code(
                `print Console.sprintf("Hello, %s!", "World")`,
                `Hello, World!`
            ))
        });
