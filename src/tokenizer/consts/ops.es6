...
export const RESERVED_KEYWORDS = [ 'sqrt', 'cbrt', 'sin', 'cos', 'tan', 'cosh', 'sinh', 'tanh', 'acos', 'asin', 'atan', 'acosh', 'asinh', 'atanh', 'log', 'log10', 'log1p', 'log2', 'floor', 'ceil', 'round', 'sign', 'imul', 'abs', 'clz32', 'fround', 'print' ];
