...
var VSLTokExpression = (function (_VSLTok) {
    _inherits(VSLTokExpression, _VSLTok);

    function VSLTokExpression() {
        var Code = arguments.length <= 0 || arguments[0] === undefined ? "" : arguments[0];
        var Index = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];

        _classCallCheck(this, VSLTokExpression);

        _get(Object.getPrototypeOf(VSLTokExpression.prototype), 'constructor', this).call(this, Code, Index);
    }

    _createClass(VSLTokExpression, [{
        key: 'exec',
        value: function exec() {
    ...
    return VSLTokExpression;
})(VSLTok);

exports['default'] = VSLTokExpression;
